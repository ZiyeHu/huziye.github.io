        ...
        with tf.variable_scope('model', reuse=tf.AUTO_REUSE) as training_scope:
            ...
            def batch_metalearn(inp):
                ...
                if 'Training' in prefix:
                    embed_outputa, _ = embed_forward(conv_out_size, compare_inputa, weights,
                                                     network_config=network_config)
                else:
                    embed_outputa, _ = embed_forward(conv_out_size, compare_inputa, weights, is_training=False,
                ...
                # embedding
                if 'Training' in prefix:
                    embed_outputa, _ = embed_forward(conv_out_size, compare_inputa, fast_weights, meta_testing=True,
                                                     network_config=network_config)
                else:
                    embed_outputa, _ = embed_forward(conv_out_size, compare_inputa, fast_weights, meta_testing=True,
