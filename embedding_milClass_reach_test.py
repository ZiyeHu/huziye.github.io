    ...
    with graph.as_default():
        ...
        with tf.variable_scope('model', reuse=tf.AUTO_REUSE) as training_scope:
            ...
            def batch_metalearn(inp):
                ...
                # semantic_outputa = local_outputa[:, :,2:]
                # local_outputa = local_outputa[:, :, :2]
                ...
                semantic_outputb = outputb[:, 2:]
                semantic_outputb = tf.nn.softmax(semantic_outputb)
                outputb = outputb[:,0:2]



                compare_semantic_outputb = compare_outputb[:, 2:]
                compare_semantic_outputb = tf.nn.softmax(compare_semantic_outputb)
                compare_outputb = compare_outputb[:, 0:2]

                different_semantic_outputb = different_outputb[:, 2:]
                different_semantic_outputb = tf.nn.softmax(different_semantic_outputb)
                different_outputb = different_outputb[:, 0:2]
