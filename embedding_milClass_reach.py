        ...
        with tf.variable_scope('model', reuse=tf.AUTO_REUSE) as training_scope:
            ...
            def batch_metalearn(inp):
                ...
                semantic_loss =  1e3 * act_loss_eps * euclidean_loss_layer(semantic_outputb, compare_semantic_outputb, multiplier=loss_multiplier,use_l1=FLAGS.use_l1_l2_loss) +\
                                 tf.abs((1.0 - 1e3 *  act_loss_eps * euclidean_loss_layer(semantic_outputb, different_semantic_outputb, multiplier=loss_multiplier, use_l1=FLAGS.use_l1_l2_loss)))+ \
                                 tf.abs((1.0 - 1e3 *  act_loss_eps * euclidean_loss_layer(compare_semantic_outputb, different_semantic_outputb, multiplier=loss_multiplier, use_l1=FLAGS.use_l1_l2_loss)))
