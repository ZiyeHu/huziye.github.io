    ...
    def construct_model(self, input_tensors=None, prefix='Training_', dim_input=27, dim_output=7, network_config=None):
        ...
        with tf.variable_scope('model', reuse=None) as training_scope:
            ...
            def batch_metalearn(inp):
                ...
                local_lossa = act_loss_eps * euclidean_loss_layer(local_outputa, tf.zeros_like(actiona), multiplier=loss_multiplier, use_l1=FLAGS.use_l1_l2_loss)
                if FLAGS.learn_final_eept:
                ...
                if 'Training' in prefix:
                    ...
                    clone_outputa, _ = self.forward(inputa, state_inputa, fast_weights, meta_testing=True, network_config=network_config)
                else:
                    ...
                    clone_outputa, _= self.forward(inputa, state_inputa, fast_weights, meta_testing=True, is_training=False, testing=testing, network_config=network_config)
                ...
                local_lossb = 0.5 * (act_loss_eps * euclidean_loss_layer(outputb, actionb, multiplier=loss_multiplier, use_l1=FLAGS.use_l1_l2_loss) + \
                                act_loss_eps * euclidean_loss_layer(clone_outputa, actiona, multiplier=loss_multiplier, use_l1=FLAGS.use_l1_l2_loss))
