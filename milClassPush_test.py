...
flags.DEFINE_string('experiment', 'sim__push', 'sim_vision_reach or sim_push')
...
def main():
    ...
    with graph.as_default():
        ...
        class TFAgent(object):
            ...
            def get_vision_action(self, image, obs, t=-1):
                ...
                if self.scale is not None:
                    ...
                    # action = self.sess.run(global_test_act_op,
                    #                        {global_statea: self.zero_demoX,
                    #                         global_obsa: self.demoVideo,
                    #                         global_actiona: self.zero_demoU,
        ...
        def evaluate_push(sess, graph,  exp_string, log_dir, demo_dir, id=-1, save_video=True,
                          num_input_demos=1):
