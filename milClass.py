...
flags.DEFINE_integer('num_filters', 40,
...
flags.DEFINE_integer('n_shot', 1, 'N-shot')
    ...
    with graph.as_default():
        ...
        with tf.variable_scope('model', reuse=tf.AUTO_REUSE) as training_scope:
            ...
            def batch_metalearn(inp):
                ...
                for iters in range (FLAGS.n_shot-1):
                    print('iters',iters+1)
                    ...
                    with tf.variable_scope('select_model', reuse=tf.AUTO_REUSE) as select_scope:
                        ...
                        outputb=compare_learn_outputb+outputb


                    print('outputb is from multi-learning')

                outputb = outputb/FLAGS.n_shot
