...
def train(model, saver, sess, exp_string, data_generator, resume_itr=0):
    ...
    for itr in range(resume_itr, FLAGS.pretrain_iterations + FLAGS.metatrain_iterations):
        ...
        if 'generate' in dir(data_generator):
            ...
            feed_dict = {model.inputa: inputa, model.inputb: inputb,  model.labela: labela, model.labelb: labelb, model.disturb: np.random.normal(0, 1.0, 1)}
...
def test(model, saver, sess, exp_string, data_generator, test_num_updates=None):
    ...
    for _ in range(NUM_TEST_POINTS):
        if 'generate' not in dir(data_generator):
            ...
            feed_dict = {model.inputa: inputa, model.inputb: inputb,  model.labela: labela, model.labelb: labelb, model.meta_lr: 0.0, model.disturb:0.0}
